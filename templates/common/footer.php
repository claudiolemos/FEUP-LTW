  ...
  <div id="about-pop-up" class="pop-up">
    <form method="post" class="pop-up-content animate" action="/../actions/create_channel.php">
      ...
      <div class="container">
        ...
        <a href="https://sigarra.up.pt/feup/pt/fest_geral.cursos_list?pv_num_unico=201603542"><img src="https://imgur.com/jw8TDT7.jpg" style="width:75px; height:75px; margin:5px; border-radius:50%;"></a>
        <a href="https://sigarra.up.pt/feup/pt/fest_geral.cursos_list?pv_num_unico=201607176"><img src="https://imgur.com/bbYndza.jpg" style="width:75px; height:75px; margin:5px; border-radius:50%;"></a>
        <a href="https://sigarra.up.pt/feup/pt/fest_geral.cursos_list?pv_num_unico=201200647"><img src="https://imgur.com/cCSjkb2.jpg" style="width:75px; height:75px; margin:5px; border-radius:50%;"></a>
      </div>
    </form>
  </div>
</footer>
