...
$(document.body).on('click', '.post-comment-btn' ,function(e){
	...
	if(comment == "" || comment == undefined){
        ...
        checkmentions.open("post", "/../actions/api_check_mentions.php", true); //TODO
        ...
        //TODO COMMENT NAO ESTA A IR ALTERADO N SEI PQ
        let request = new XMLHttpRequest();
    	request.open("post", "/../actions/api_post_comment.php", true); //TODO
